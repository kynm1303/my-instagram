...
import {
    Dimensions, FlatList, Image, ScrollView, StyleSheet, Text, TouchableOpacity, View, VirtualizedList
} from "react-native";
...
export default function VideoScreen({ navigation }) {
    ...
    const imagePreviewComponent = <View
    ...
    const buttons = <View style={{ justifyContent: 'flex-end', alignItems: 'center', marginRight: 20, marginVertical: 10, flexDirection: 'row' }}>
        <TouchableOpacity
    ...
    // console.log("Camera: ", galleryItems.assets);
